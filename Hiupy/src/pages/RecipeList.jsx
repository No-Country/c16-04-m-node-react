                ...
                <div className="w-full h-screen box-border">
                    <div className="flex flex-col px-6 align-middle gap-y-3">
                        ...
                        <ul className=" text-xs space-y-3 max-w-96">
                            <h2 className=" font-semibold text-base underline">Ingredientes</h2>
                            ...
                            <li className=" flex justify-between"> 
                                <label>⅓ taza de cebolla verde y sus hojas, cortado en rodajas</label>
                                <input type="checkbox" />
                            </li>
                            <li className=" flex justify-between">
                            ...
                            <li className=" flex justify-between"> 
                                <label>2 cucharadas de salsa de soya baja en sodio</label>
                                <input type="checkbox" />
                            </li>
                        </ul>
                    </div>
